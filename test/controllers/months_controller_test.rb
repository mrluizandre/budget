...
class MonthsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create month" do
    assert_difference('Month.count') do
      post months_url, params: { month: { activity: @month.activity, budgeted: @month.budgeted, income: @month.income, month: @month.month, to_be_budgeted: @month.to_be_budgeted } }
    end
  ...
  test "should update month" do
    patch month_url(@month), params: { month: { activity: @month.activity, budgeted: @month.budgeted, income: @month.income, month: @month.month, to_be_budgeted: @month.to_be_budgeted } }
